        ...
        <div className="p-6">
          ...
          <nav className="space-y-1">
            ...
            <a className="group flex items-center gap-3 px-3 py-2 rounded-lg bg-primary/10 border border-primary/20 shadow-[0_0_15px_rgba(167,242,74,0.1)]" href="#">
              ...
              <p className="text-primary text-[11px] font-mono tracking-tighter neon-glow">03_BNPL_REPAYMENTS</p>
        ...
        <div className="max-w-4xl mx-auto px-8 py-10">
          ...
          <div className="mb-12">
            ...
            <p className="text-white/50 text-base font-mono leading-relaxed max-w-2xl uppercase tracking-tight">
              Technical specifications for the crypto-collateralized Buy Now Pay Later protocol. This module governs automated repayment schedules and collateral health monitoring.
            </p>
          </div>
          ...
          <div className="space-y-12 pb-24">
            <section id="ltv-ratios">
              ...
              <p className="text-white/60 font-mono text-xs leading-relaxed mb-6 uppercase tracking-wide">
                The Polaris BNPL engine calculates credit availability based on the real-time valuation of staked assets (TVL). The standard formula incorporates a dynamic haircut based on asset volatility indices (VI).
              </p>
              ...
              <div className="terminal-block rounded-xl overflow-hidden shadow-2xl">
                <div className="bg-white/5 px-4 py-2 flex items-center justify-between border-b border-white/5">
                  ...
                  <span className="text-[9px] font-mono text-white/30 uppercase tracking-widest">bash — polaris-cli</span>
                </div>
            ...
            <section id="collateral-health">
              ...
              <p className="text-white/60 font-mono text-xs leading-relaxed mb-4 uppercase tracking-wide">
                Collateral health is monitored block-by-block via the Polaris Oracle Network. When the LTV ratio exceeds the threshold (default 85%), the contract enters a 'GRACE_PERIOD' state before partial liquidation occurs.
              </p>
